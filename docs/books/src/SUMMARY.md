...
- [Cookbook](cookbook/index.md)
  ...
  - [Find images missing alt text](cookbook/find-images-missing-alt-text.md)
  - [Extract blockquotes as pull quotes](cookbook/extract-blockquotes-as-pull-quotes.md)
  - [Extract footnote definitions](cookbook/extract-footnote-definitions.md)
  - [Find raw HTML blocks](cookbook/find-raw-html-blocks.md)
  ...
  - [Redact secrets from JSON, YAML, TOML or Markdown data](cookbook/redact-secrets-from-json.md)
  ...
  - [Fill blank cells in a Markdown table](cookbook/fill-blank-table-cells.md)
  ...
  - [Turn JSON into a Markdown table](cookbook/json-to-markdown-table.md)
  - [Generate Markdown from data](cookbook/generate-markdown-with-md-module.md)
  - [Convert between YAML and JSON](cookbook/convert-yaml-and-json.md)
  - [Read values from a TOML file](cookbook/read-toml-values.md)
  - [Read values from an XML file](cookbook/read-values-from-xml.md)
  - [Convert between XML and JSON](cookbook/convert-xml-and-json.md)
  - [Query XML with XPath](cookbook/query-xml-with-xpath.md)
  - [Flatten JSON into greppable paths](cookbook/flatten-json-with-gron.md)
  - [Compact JSON with TOON for LLM prompts](cookbook/compact-json-with-toon.md)
  - [Decode a CBOR payload](cookbook/decode-cbor-payload.md)
  - [Extract links from an HTML page](cookbook/extract-links-from-html.md)
  - [Sort versions and find the latest release](cookbook/find-latest-version-with-semver.md)
  - [Find the closest heading to a misspelled name](cookbook/fuzzy-match-headings.md)
