...
<tr data-category="terminal-text"><td><a href="https://github.com/harehare/cmd.mq">cmd.mq</a></td><td><span class="module-category-badge">Terminal &amp; Text</span></td><td>Command output parsers (<code>ps</code>, <code>df</code>, <code>ls -l</code>, <code>git log</code>, ...) that turn CLI output into structured data</td></tr>
