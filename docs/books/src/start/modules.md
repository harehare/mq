...
<tr data-category="format-parsers"><td><a href="https://github.com/harehare/ltsv.mq">ltsv.mq</a></td><td><span class="module-category-badge">Format Parsers</span></td><td><a href="http://ltsv.org/">LTSV</a> (Labeled Tab-Separated Values) parser</td></tr>
...
<tr data-category="format-parsers"><td><a href="https://github.com/harehare/sbom.mq">sbom.mq</a></td><td><span class="module-category-badge">Format Parsers</span></td><td>SPDX and CycloneDX SBOM (Software Bill of Materials) parser</td></tr>
<tr data-category="format-parsers"><td><a href="https://github.com/harehare/fixedwidth.mq">fixedwidth.mq</a></td><td><span class="module-category-badge">Format Parsers</span></td><td>Fixed-width (fixed-length) text parser</td></tr>
...
<tr data-category="terminal-text"><td><a href="https://github.com/harehare/cmdparse.mq">cmdparse.mq</a></td><td><span class="module-category-badge">Terminal &amp; Text</span></td><td>Command output parsers (<code>ps</code>, <code>df</code>, <code>ls -l</code>, <code>git log</code>, ...) that turn CLI output into structured data</td></tr>
