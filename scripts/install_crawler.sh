...
# mq-crawler installation script
...
EOF
    echo -e "${BOLD}${CYAN}              Markdown Crawler${NC}"
    echo -e "${BLUE}   A tool for crawling directories and collecting${NC}"
    echo -e "${BLUE}       Markdown files for batch processing${NC}"
    echo ""
    echo -e "${PURPLE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
}
...
install_mqcr() {
    ...
    log "Downloading mq-crawler $version for $os/$arch..."
    ...
    if ! curl -L --progress-bar "$download_url" -o "$temp_file"; then
        error "Failed to download mq-crawler binary"
    fi
...
show_post_install() {
    echo ""
    echo -e "${PURPLE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${BOLD}${GREEN}✨ mq-crawler installed successfully! ✨${NC}"
    echo -e "${PURPLE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
...
while [[ $# -gt 0 ]]; do
    case $1 in
        --help|-h)
            echo "mq-crawler installation script"
            echo ""
            ...
            ;;
        --version|-v)
            echo "mq-crawler installer v1.0.0"
            exit 0
            ;;
        *)
