...
#[case::while_continue("
    ...
    ",
      vec![Value::Number(10.into())],
      Ok(vec![Value::Array(vec![Value::Number(1.into()), Value::Number(2.into()), Value::Number(4.into())])].into()))]
#[case::until_break("
    let x = 0 |
    until(x < 10):
      let x = x + 1
...
#[case::foreach_continue("
    ...
    ",
      vec![Value::Number(0.into())],
      Ok(vec![Value::Array(vec![Value::Number(11.into()), Value::Number(12.into()), Value::Number(14.into()), Value::Number(15.into())])].into()))]
#[case::if_("
    def fibonacci(x):
      if(eq(x, 0)):
        0
