...
const fn const_fnv1a_hash_64(s: &str) -> u64 {
...
const HASH_ABS: u64 = const_fnv1a_hash_64("abs");
const HASH_ADD: u64 = const_fnv1a_hash_64("add");
const HASH_AND: u64 = const_fnv1a_hash_64(constants::AND);
const HASH_ARRAY: u64 = const_fnv1a_hash_64(constants::ARRAY);
const HASH_ATTR: u64 = const_fnv1a_hash_64(constants::ATTR);
const HASH_BASE64: u64 = const_fnv1a_hash_64("base64");
const HASH_BASE64D: u64 = const_fnv1a_hash_64("base64d");
const HASH_CEIL: u64 = const_fnv1a_hash_64("ceil");
const HASH_COMPACT: u64 = const_fnv1a_hash_64("compact");
const HASH_DECREASE_HEADER_LEVEL: u64 = const_fnv1a_hash_64("decrease_header_level");
const HASH_DEL: u64 = const_fnv1a_hash_64("del");
const HASH_DICT: u64 = const_fnv1a_hash_64(constants::DICT);
const HASH_DIV: u64 = const_fnv1a_hash_64(constants::DIV);
const HASH_DOWNCASE: u64 = const_fnv1a_hash_64("downcase");
const HASH_ENDS_WITH: u64 = const_fnv1a_hash_64("ends_with");
const HASH_ENTRIES: u64 = const_fnv1a_hash_64("entries");
const HASH_EQ: u64 = const_fnv1a_hash_64(constants::EQ);
const HASH_ERROR: u64 = const_fnv1a_hash_64("error");
const HASH_EXPLODE: u64 = const_fnv1a_hash_64("explode");
const HASH_FLATTEN: u64 = const_fnv1a_hash_64("flatten");
const HASH_FLOOR: u64 = const_fnv1a_hash_64("floor");
const HASH_FROM_DATE: u64 = const_fnv1a_hash_64("from_date");
const HASH_GET: u64 = const_fnv1a_hash_64(constants::GET);
const HASH_GT: u64 = const_fnv1a_hash_64(constants::GT);
const HASH_GTE: u64 = const_fnv1a_hash_64(constants::GTE);
const HASH_GET_TITLE: u64 = const_fnv1a_hash_64("get_title");
const HASH_GET_URL: u64 = const_fnv1a_hash_64("get_url");
const HASH_GSUB: u64 = const_fnv1a_hash_64("gsub");
const HASH_HALT: u64 = const_fnv1a_hash_64("halt");
const HASH_IMPLODE: u64 = const_fnv1a_hash_64("implode");
const HASH_INCREASE_HEADER_LEVEL: u64 = const_fnv1a_hash_64("increase_header_level");
const HASH_INDEX: u64 = const_fnv1a_hash_64("index");
const HASH_INSERT: u64 = const_fnv1a_hash_64("insert");
const HASH_JOIN: u64 = const_fnv1a_hash_64("join");
const HASH_KEYS: u64 = const_fnv1a_hash_64("keys");
const HASH_LEN: u64 = const_fnv1a_hash_64("len");
const HASH_LT: u64 = const_fnv1a_hash_64(constants::LT);
const HASH_LTE: u64 = const_fnv1a_hash_64(constants::LTE);
const HASH_MATCH: u64 = const_fnv1a_hash_64("match");
const HASH_MAX: u64 = const_fnv1a_hash_64("max");
const HASH_MIN: u64 = const_fnv1a_hash_64("min");
const HASH_MOD: u64 = const_fnv1a_hash_64(constants::MOD);
const HASH_MUL: u64 = const_fnv1a_hash_64(constants::MUL);
const HASH_NE: u64 = const_fnv1a_hash_64(constants::NE);
const HASH_NOT: u64 = const_fnv1a_hash_64(constants::NOT);
const HASH_NOW: u64 = const_fnv1a_hash_64("now");
const HASH_OR: u64 = const_fnv1a_hash_64(constants::OR);
const HASH_POW: u64 = const_fnv1a_hash_64("pow");
const HASH_PRINT: u64 = const_fnv1a_hash_64("print");
const HASH_RANGE: u64 = const_fnv1a_hash_64(constants::RANGE);
const HASH_REPEAT: u64 = const_fnv1a_hash_64("repeat");
const HASH_REPLACE: u64 = const_fnv1a_hash_64("replace");
const HASH_REVERSE: u64 = const_fnv1a_hash_64("reverse");
const HASH_RINDEX: u64 = const_fnv1a_hash_64("rindex");
const HASH_ROUND: u64 = const_fnv1a_hash_64("round");
const HASH_SET: u64 = const_fnv1a_hash_64("set");
const HASH_SET_ATTR: u64 = const_fnv1a_hash_64("set_attr");
const HASH_SET_CHECK: u64 = const_fnv1a_hash_64("set_check");
const HASH_SET_CODE_BLOCK_LANG: u64 = const_fnv1a_hash_64("set_code_block_lang");
const HASH_SET_LIST_ORDERED: u64 = const_fnv1a_hash_64("set_list_ordered");
const HASH_SET_REF: u64 = const_fnv1a_hash_64("set_ref");
const HASH_SLICE: u64 = const_fnv1a_hash_64(constants::SLICE);
const HASH_SORT: u64 = const_fnv1a_hash_64("sort");
const HASH_SORT_BY_IMPL: u64 = const_fnv1a_hash_64("_sort_by_impl");
const HASH_SPLIT: u64 = const_fnv1a_hash_64("split");
const HASH_STARTS_WITH: u64 = const_fnv1a_hash_64("starts_with");
const HASH_STDERR: u64 = const_fnv1a_hash_64("stderr");
const HASH_SUB: u64 = const_fnv1a_hash_64(constants::SUB);
const HASH_TO_ARRAY: u64 = const_fnv1a_hash_64("to_array");
const HASH_TO_CODE: u64 = const_fnv1a_hash_64("to_code");
const HASH_TO_CODE_INLINE: u64 = const_fnv1a_hash_64("to_code_inline");
const HASH_TO_DATE: u64 = const_fnv1a_hash_64("to_date");
const HASH_TO_EM: u64 = const_fnv1a_hash_64("to_em");
const HASH_TO_H: u64 = const_fnv1a_hash_64("to_h");
const HASH_TO_HR: u64 = const_fnv1a_hash_64("to_hr");
const HASH_TO_HTML: u64 = const_fnv1a_hash_64("to_html");
const HASH_TO_IMAGE: u64 = const_fnv1a_hash_64("to_image");
const HASH_TO_LINK: u64 = const_fnv1a_hash_64("to_link");
const HASH_TO_MARKDOWN_STRING: u64 = const_fnv1a_hash_64("to_markdown_string");
const HASH_TO_MATH: u64 = const_fnv1a_hash_64("to_math");
const HASH_TO_MATH_INLINE: u64 = const_fnv1a_hash_64("to_math_inline");
const HASH_TO_MD_LIST: u64 = const_fnv1a_hash_64("to_md_list");
const HASH_TO_MD_NAME: u64 = const_fnv1a_hash_64("to_md_name");
const HASH_TO_MD_TABLE_ROW: u64 = const_fnv1a_hash_64("to_md_table_row");
const HASH_TO_MD_TEXT: u64 = const_fnv1a_hash_64("to_md_text");
const HASH_TO_NUMBER: u64 = const_fnv1a_hash_64("to_number");
const HASH_TO_STRING: u64 = const_fnv1a_hash_64("to_string");
const HASH_TO_STRONG: u64 = const_fnv1a_hash_64("to_strong");
const HASH_TO_TEXT: u64 = const_fnv1a_hash_64("to_text");
const HASH_TO_TSV: u64 = const_fnv1a_hash_64("to_tsv");
const HASH_TRUNC: u64 = const_fnv1a_hash_64("trunc");
const HASH_TRIM: u64 = const_fnv1a_hash_64("trim");
const HASH_TYPE: u64 = const_fnv1a_hash_64("type");
const HASH_UNIQ: u64 = const_fnv1a_hash_64("uniq");
const HASH_UPDATE: u64 = const_fnv1a_hash_64("update");
const HASH_UPCASE: u64 = const_fnv1a_hash_64("upcase");
const HASH_URL_ENCODE: u64 = const_fnv1a_hash_64("url_encode");
const HASH_UTF8BYTELEN: u64 = const_fnv1a_hash_64("utf8bytelen");
const HASH_VALUES: u64 = const_fnv1a_hash_64("values");
#[cfg(feature = "file-io")]
const HASH_READ_FILE: u64 = const_fnv1a_hash_64("read_file");

pub fn get_builtin_functions(name: &AstIdentName) -> Option<&'static BuiltinFunction> {
    let name = const_fnv1a_hash_64(name.as_str());
    match name {
        HASH_ABS => Some(&ABS),
        HASH_ADD => Some(&ADD),
        HASH_AND => Some(&AND),
