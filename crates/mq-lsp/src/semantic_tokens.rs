    ...
    for symbol in symbols.into_iter().sorted_by_key(|symbol| symbol.source.text_range) {
        ...
        if let Some(range) = &symbol.source.text_range {
            ...
            let token_type = match symbol.kind {
                ...
                mq_hir::SymbolKind::Assign
                | mq_hir::SymbolKind::BinaryOp
                | mq_hir::SymbolKind::UnaryOp
                | mq_hir::SymbolKind::Spread => token_type(ls_types::SemanticTokenType::OPERATOR),
                ...
                mq_hir::SymbolKind::String | mq_hir::SymbolKind::Bytes | mq_hir::SymbolKind::InterpolatedString => {
