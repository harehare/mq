use mdq_lang::{Engine, MdqResult, Value};
...
#[case::test("select(contains(\"hello\"))",
      vec![Value::Markdown(mdq_md::Node::Text(mdq_md::Text{value: "hello world".to_string(), position: None}))],
      Ok(vec![Value::Markdown(mdq_md::Node::Text(mdq_md::Text{value: "hello world".to_string(), position: None}))].into()))]
// first
