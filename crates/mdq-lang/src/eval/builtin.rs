...
pub static BUILTIN_FUNCTIONS: LazyLock<FxHashMap<CompactString, BuiltinFunction>> =
    LazyLock::new(|| {
        ...
        map.insert(
            ...
            BuiltinFunction::new(ParamNum::Fixed(1), |ident, args| match args.as_slice() {
                [RuntimeValue::String(s)] => Ok(mdq_md::to_html(s).into()),
                [RuntimeValue::Markdown(node_value)] => {
                    Ok(mdq_md::to_html(node_value.to_string().as_str()).into())
                }
                [a] => Err(Error::InvalidTypes(ident.to_string(), vec![a.clone()])),
                _ => unreachable!(),
            }),
        ...
        map.insert(
            ...
            BuiltinFunction::new(ParamNum::Fixed(2), |_, args| match args.as_slice() {
                [a, RuntimeValue::String(lang)] => Ok(mdq_md::Node::Code(mdq_md::Code {
                    value: a.to_string(),
                    lang: Some(lang.to_string()),
                    position: None,
                })
                .into()),
                [a, RuntimeValue::None] => Ok(mdq_md::Node::Code(mdq_md::Code {
                    value: a.to_string(),
                    lang: None,
                    position: None,
                })
        ...
        map.insert(
            ...
            BuiltinFunction::new(ParamNum::Fixed(1), |_, args| match args.as_slice() {
                [a] => Ok(mdq_md::Node::CodeInline(mdq_md::CodeInline {
                    value: a.to_string(),
                    position: None,
                })
                .into()),
        ...
        map.insert(
            ...
            BuiltinFunction::new(ParamNum::Fixed(2), |_, args| match args.as_slice() {
                [RuntimeValue::Markdown(node), RuntimeValue::Number(depth)] => {
                    Ok(mdq_md::Node::Heading(mdq_md::Heading {
                ...
                [a, RuntimeValue::Number(depth)] => Ok(mdq_md::Node::Heading(mdq_md::Heading {
                    depth: (*depth).value() as u8,
        ...
        map.insert(
            ...
            BuiltinFunction::new(ParamNum::Fixed(0), |_, _| {
                Ok(mdq_md::Node::HorizontalRule { position: None }.into())
            }),
        );
        map.insert(
            ...
            BuiltinFunction::new(ParamNum::Fixed(2), |ident, args| match args.as_slice() {
                [RuntimeValue::String(url), RuntimeValue::String(title)] => {
                    Ok(mdq_md::Node::Link(mdq_md::Link {
                        url: url.to_string(),
        ...
        map.insert(
            ...
            BuiltinFunction::new(ParamNum::Fixed(3), |_, args| match args.as_slice() {
                ...
                ] => Ok(mdq_md::Node::Image(mdq_md::Image {
                    alt: alt.to_string(),
                    url: url.to_string(),
                    title: Some(title.to_string()),
                    position: None,
        ...
        map.insert(
            ...
            BuiltinFunction::new(ParamNum::Fixed(1), |_, args| match args.as_slice() {
                [a] => Ok(mdq_md::Node::Math(mdq_md::Math {
                    value: a.to_string(),
                    position: None,
                })
                .into()),
        ...
        map.insert(
            ...
            BuiltinFunction::new(ParamNum::Fixed(1), |_, args| match args.as_slice() {
                [a] => Ok(mdq_md::Node::MathInline(mdq_md::MathInline {
                    value: a.to_string(),
                    position: None,
                })
                .into()),
        ...
        map.insert(
            ...
            BuiltinFunction::new(ParamNum::Fixed(1), |_, args| match args.as_slice() {
                [RuntimeValue::Markdown(node)] => Ok(mdq_md::Node::Strong(mdq_md::Value {
                    value: node.node_value(),
                    position: None,
                })
                .into()),
                [a] => Ok(mdq_md::Node::Strong(mdq_md::Value {
                    value: Box::new(a.to_string().into()),
                    position: None,
                })
                .into()),
        ...
        map.insert(
            ...
            BuiltinFunction::new(ParamNum::Fixed(1), |_, args| match args.as_slice() {
                [RuntimeValue::Markdown(node)] => Ok(mdq_md::Node::Emphasis(mdq_md::Value {
                    value: node.node_value(),
                    position: None,
                })
                .into()),
                [a] => Ok(mdq_md::Node::Emphasis(mdq_md::Value {
                    value: Box::new(a.to_string().into()),
                    position: None,
                })
                .into()),
        ...
        map.insert(
            ...
            BuiltinFunction::new(ParamNum::Fixed(1), |_, args| match args.as_slice() {
                [a] => Ok(mdq_md::Node::Text(mdq_md::Text {
                    value: a.to_string(),
                    position: None,
                })
                .into()),
        ...
        map.insert(
            ...
            BuiltinFunction::new(ParamNum::Fixed(2), |_, args| match args.as_slice() {
                [RuntimeValue::Markdown(node), RuntimeValue::Number(indent)] => {
                    Ok(mdq_md::Node::List(mdq_md::List {
                        value: node.node_value(),
                        index: 0,
                ...
                [a, RuntimeValue::Number(indent)] => Ok(mdq_md::Node::List(mdq_md::List {
                    value: Box::new(a.to_string().into()),
                    index: 0,
                    indent: indent.value() as u8,
                    checked: None,
        ...
        map.insert(
            ...
            BuiltinFunction::new(ParamNum::Fixed(2), |_, args| match args.as_slice() {
                [
                    RuntimeValue::Markdown(mdq_md::Node::List(list)),
...
#[inline(always)]
pub fn eval_selector(node: mdq_md::Node, selector: &ast::Selector) -> Vec<RuntimeValue> {
    match selector {
        ...
        ast::Selector::Table(row, column) => match (row, column, node.clone()) {
            (
                Some(row1),
                Some(column1),
                mdq_md::Node::TableCell(mdq_md::TableCell {
                    column: column2,
                    row: row2,
                    last_cell_in_row: _,
            ...
            (Some(row1), None, mdq_md::Node::TableCell(mdq_md::TableCell { row: row2, .. })) => {
                if *row1 == row2 {
                    vec![RuntimeValue::Markdown(node)]
                } else {
                    Vec::new()
            ...
            (None, None, mdq_md::Node::TableCell(_)) => {
                vec![RuntimeValue::Markdown(node)]
            }
            _ => Vec::new(),
        },
        ...
        ast::Selector::List(index, checked) => match (index, node.clone()) {
            ...
            (_, mdq_md::Node::List(mdq_md::List { .. })) => {
                vec![RuntimeValue::Markdown(node)]
            }
            _ => Vec::new(),
        },
