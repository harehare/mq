...
fn highlight_mq_syntax(line: &str) -> Cow<'_, str> {
    ...
    let keywords_pattern = r"\b(def|let|if|elif|else|end|while|foreach|self|nodes|fn|break|continue|include|true|false|None|match|import|module|do|var|macro)\b";
